...
class DriverHomeActivity : AppCompatActivity() {
            ...
            if (it.itemId == R.id.nav_sign_out)
            {
                ...
                builder.setTitle("Sign out")
                    ...
                    .setPositiveButton("SIGN OUT") {dialogInterface, _ ->
                        ...
                        val intent = Intent(this@DriverHomeActivity,
                ...
                dialog.setOnShowListener{
                    ...
                    dialog.getButton(AlertDialog.BUTTON_NEGATIVE)
                        .setTextColor(ContextCompat.getColor(this@DriverHomeActivity,
                            R.color.colorAccent
                        ))
    ...
    private fun showDialogUpload() {
        ...
        builder.setTitle("Change Picture")
            .setMessage("Do you really want to change picture ?")
            .setNegativeButton("CANCEL", { dialogInterface, _ -> dialogInterface.dismiss()})
            .setPositiveButton("CHANGE") {dialogInterface, _ ->
                if (imageUri != null)
                {
                    waitingDialog.show()
                    val avatarFolder = storageRefrence.child("avatars/"+ FirebaseAuth.getInstance().currentUser!!.uid)
